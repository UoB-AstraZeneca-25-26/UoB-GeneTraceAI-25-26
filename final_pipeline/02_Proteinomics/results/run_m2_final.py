...
spec = importlib.util.spec_from_file_location('m2', r'C:\Disertation\UoB-GeneTraceAI-25-26\final_pipeline\02_Proteinomics\06_protein_score_M2.py')
m2 = importlib.util.module_from_spec(spec)
spec.loader.exec_module(m2)
import duckdb

t0 = time.time()
con = duckdb.connect(r'C:\Disertation\UoB-GeneTraceAI-25-26\final_pipeline\outputs\celllineselector.db', read_only=True)
...
out_dir = r'C:\Disertation\UoB-GeneTraceAI-25-26\final_pipeline\02_Proteinomics\results'
