...
Writes: final_pipeline/outputs/ci_scores.parquet
"""
import sys, time
...
PIPELINE_ROOT = Path("/Users/musa.official/Documents/UoB-GeneTraceAI-25-26/final_pipeline")  # <-- the folder with config.py
