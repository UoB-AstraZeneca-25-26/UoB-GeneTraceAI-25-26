...
Known gaps: Fusions (271 orphaned) and Signatures (251 orphaned) have elevated orphan rates.
Flagged for Track A to investigate — likely a sample_info version mismatch.
...
`logs/unmapped_{dataset_name}.csv`
