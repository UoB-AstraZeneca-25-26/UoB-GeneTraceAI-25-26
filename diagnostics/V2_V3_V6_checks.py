...
if len(both_genes) == 0:
    ...
    for gene_id in both_genes:
        ...
        if n_driver == 0:
            ...
            mut_path = REPO / "final_pipeline" / "outputs" / "mutations_scores.parquet"
            fus_path = REPO / "final_pipeline" / "outputs" / "fusions_scores.parquet"
            cna_path = REPO / "final_pipeline" / "outputs" / "cna_flags.parquet"
