...
sys.path.insert(0, str(ROOT / "architecture" / "cell_similarity"))
...
S = pd.read_parquet(ROOT / "architecture" / "cell_similarity" / "outputs" / "rna_similarity.parquet")
lin = C.load_lineage()
...
_ga_spec = _ilu.spec_from_file_location("gate_audit_common",
                                        ROOT / "Testing and validation" / "gate_audit" / "common.py")
...
expr_path = ROOT / "architecture" / "cell_similarity" / "outputs" / "expression_24q4.parquet"
...
gene_lookup_path = ROOT / "architecture" / "reference" / "gene_lookup.parquet"
ensg2sym = {}
